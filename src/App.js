...
const defs = [
  "television or movie related images",
...
const syn = [
  "television images, record, movie",
...
const examples = [
  "We bought a video camera last week.",
...
class App extends Component {
  handleOptionChange = (changeEvent) => {
    ...
    if (
      Number(changeEvent.target.value) === Number(this.state.index) ||
      Number(changeEvent.target.className) === Number(this.state.index)
    ) {
  ...
  findExample = () => {
    ...
    if (insertIndex < examples[this.state.index].length - 1) {
      while (
        !charArray.includes(
          examples[this.state.index][
            indexPlusExtra + words[this.state.index].length
          ]
        )
      ) {
        //Get complete word before next space if not at end of sentence
        indexPlusExtra++;
      }
    }

    switch (
      words[this.state.index] //Exceptions for irregular verbs
    ) {
      case "become":
    ...
    secondHalf = examples[this.state.index].substring(
      indexPlusExtra + words[this.state.index].length,
      examples[this.state.index].length
    ); //Sentence after word
  };
  ...
  createNums = () => {
    ...
    for (let i = 0; i < randNums.length; i++) {
      //Loops for all of randNums
      let newNum = Math.floor(Math.random() * words.length); //Selects a random number
      while (typeof randNums[i] !== "number" || syn[randNums[i]].length < 2) {
        //Reassign if new elem is not a number
        while (
          newNum === this.state.index ||
          randNums.some((num) => num === newNum) ||
          newNum > words.length - 1
        ) {
          //Change newNum until it is no longer the same as the index or is in randNums already
  ...
  next = () => {
    ...
    while (
      ...
      usedNums.some((num) => num === randomIndex) &&
      usedNums.length !== words.length &&
      !usedNums.includes(randomIndex)
    ) {
      //If it was already used and not all the words were used yet, reselect
    ...
    usedNums.push(this.state.index);
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <div
            style={{ display: this.state.showCorrect ? "block" : "none" }}
            id="correctSelected"
            class="correctAns"
          >
            <t>That's correct!</t>
          ...
          <div
            style={{ display: this.state.showWrong ? "block" : "none" }}
            id="wrongSelected"
            class="wrongAns"
          >
          ...
          <div style={{ display: this.state.showWords ? "block" : "none" }}>
            <br />
            <t class="word" style={{ fontSize: "30pt" }}>
          ...
          <div class="btnContainer">
            <button
              ...
              id="understandBtn"
              style={{
                display: this.state.showUnderstandButton ? "block" : "none",
              }}
            >
              Known
            </button>
            <button
              ...
              id="notUnderstandBtn"
              style={{
                display: this.state.showNotUnderstandButton ? "block" : "none",
              }}
            >
              Unknown
            </button>
          ...
          <div
            id="wordDef"
            class="wordDef"
            style={{ display: this.state.showDef ? "block" : "none" }}
          >
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <t class="defInfo" style={{ color: "yellow" }}>
              {defs[this.state.index]}
            </t>
            <t style={{ color: "magenta" }}>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;
              <t class="defInfo">{syn[this.state.index]}</t>
            </t>
            <t style={{ color: "cyan" }}>
              <br />
              <br />
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{firstHalf}
              <t class="defInfo" style={{ color: "white" }}>
                {examples[this.state.index].substring(
                  insertIndex,
                  indexPlusExtra + words[this.state.index].length
                )}
              </t>
            ...
            <t style={{ color: "greenyellow" }}>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <t class="defInfo">{additionalTxt}</t>
            </t>
            <br />
            <br />
            <br />
          ...
          <div
            style={{
              display: this.state.showTest ? "block" : "none",
              textAlign: "left",
            }}
          >
            <t style={{ color: "blanchedalmond" }}>
              <b>Synonym:</b>
            </t>
            <br />
            <br />
            ...
            >
              <input
                ...
                type="radio"
                value={randNums[0]}
                checked={this.state.selectedOption === randNums[0]}
                onChange={this.handleOptionChange}
              />
              <span>&nbsp;&nbsp;&nbsp;&nbsp;{syn[randNums[0]]}</span>
            </label>
            <br />
            <label className={randNums[1]} onClick={this.handleOptionChange}>
              <input
                class="radio"
                name="radio"
                type="radio"
                value={randNums[1]}
                checked={this.state.selectedOption === randNums[1]}
                onChange={this.handleOptionChange}
              />
              <span>&nbsp;&nbsp;&nbsp;&nbsp;{syn[randNums[1]]}</span>
            </label>
            <br />
            <input
              class="radio"
              type="radio"
              value={randNums[2]}
              checked={this.state.selectedOption === randNums[2]}
              onChange={this.handleOptionChange}
            />
            <label className={randNums[2]} onClick={this.handleOptionChange}>
              &nbsp;&nbsp;&nbsp;&nbsp;{syn[randNums[2]]}
            </label>
            <br />
            <label className={randNums[3]} onClick={this.handleOptionChange}>
              <input
                class="test"
                type="radio"
                value={randNums[3]}
                checked={this.state.selectedOption === randNums[3]}
                onChange={this.handleOptionChange}
              />
              <span>&nbsp;&nbsp;&nbsp;&nbsp;{syn[randNums[3]]}</span>
            </label>
            <br />
            <br />
          </div>
          <div class="btnContainer" id="notUnderstandBtn2">
            <button
              ...
              onClick={this.defineWord}
              style={{
                display: this.state.showNotUnderstandButton2 ? "block" : "none",
              }}
            >
              Unknown
            </button>
          ...
          <div
            style={{ display: this.state.showNext ? "block" : "none" }}
            id="nextBtn"
          >
            <button style={{ width: "100px" }} onClick={this.next}>
              Next
            </button>
          </div>
